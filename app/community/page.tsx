...
export default function CommunityPage() {
  ...
  async function toggleFollow(community: Community) {
    ...
    setFollowPendingId(community.id);
    try {
                    ...
                    >
                      ...
                      canFollowCommunities ? (
                        <button
                          ...
                          aria-busy={followPendingId === community.id}
                          className="inline-flex shrink-0 items-center gap-1 rounded-md px-2 py-1.5 text-xs font-semibold text-slate-500 hover:bg-slate-100 hover:text-red-600 disabled:opacity-50"
                        >
                          <FollowActionContent
                            isFollowing
                            isPending={followPendingId === community.id}
                          />
                        </button>
                      ) : (
                        canFollowCommunities && (
                          <button
                            ...
                            disabled={followPendingId !== null}
                            aria-busy={followPendingId === community.id}
                            className="inline-flex h-8 shrink-0 items-center gap-1 rounded-md bg-red-50 px-2 text-xs font-semibold text-red-600 hover:bg-red-100 disabled:opacity-50"
                          >
                            <FollowActionContent
                              isFollowing={false}
                              isPending={followPendingId === community.id}
                    ...
                    >
                      ...
                      {canFollowCommunities && (
                        <button
                          ...
                          disabled={followPendingId !== null}
                          aria-busy={followPendingId === community.id}
                          className="inline-flex h-8 items-center gap-1 rounded-md px-2 text-xs font-semibold text-slate-500 hover:bg-slate-100 hover:text-red-600 disabled:opacity-50"
                        >
                          <FollowActionContent
                            isFollowing
                            isPending={followPendingId === community.id}
                  ...
                  >
                    ...
                    {mobileSection === "followed" && canFollowCommunities && (
                      <button
                        ...
                        disabled={followPendingId !== null}
                        aria-busy={followPendingId === community.id}
                        className="inline-flex h-8 shrink-0 items-center gap-1 rounded-md px-2 text-xs font-semibold text-slate-500 hover:bg-slate-100 hover:text-red-600 disabled:opacity-50"
                      >
                        <FollowActionContent
                          isFollowing
                          isPending={followPendingId === community.id}
